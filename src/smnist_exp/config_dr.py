...
import sys
sys.path.append("C:/Users/Jaruba/Desktop/distilled_replay")  # Replace with your actual path
...
run_config = OrderedDict([
    ...
    ('distillation_method', None) # 'DM' for our Distribution Matching approach. Else: Original method.
])
